    ...
    pageActions: [
      {
        ...
        resultNote: 'Filled on the page. MARTHA CHAT STATUS was read before this fill, so these answers are no longer missing. Nothing has been sent: ask for the next missing required answer, or, at the contact step with nothing missing, ask whether to send.'
      },
      {
