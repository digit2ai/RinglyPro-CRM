...
/**
 * LOGISTICS Executive Report Generator
 *
...
async function generate(project) {
  ...
  const coverPage = [
    ...
    { text: '\n\n\n\n\n' },
    // Brand
    { text: 'LOGISTICS', fontSize: 44, bold: true, color: COLORS.blue, alignment: 'center', characterSpacing: 8 },
    { text: '\n', fontSize: 6 },
    {
  ...
  const closingPage = [
    ...
    { text: '\n\n' },
    {
      table: {
        widths: ['*'],
        body: [[{
          text: 'This report was generated by LOGISTICS — the AI-powered warehouse data analytics platform. All projections are based on the operational data provided and industry benchmarks. Actual results may vary based on implementation specifics.',
    ...
    header: (currentPage, pageCount) => {
      ...
      return {
        ...
        columns: [
          {
            stack: [
              { text: 'LOGISTICS', fontSize: 10, bold: true, color: COLORS.blue, characterSpacing: 2 },
