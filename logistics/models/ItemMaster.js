...
module.exports = (sequelize, DataTypes) => {
  const ItemMaster = sequelize.define('LogisticsItemMaster', {
    id: {
    ...
    tableName: 'logistics_item_master',
    underscored: true,
    timestamps: true,
    indexes: [
      { fields: ['project_id'] },
  ...
  ItemMaster.associate = (models) => {
    ItemMaster.belongsTo(models.LogisticsProject, { foreignKey: 'project_id', as: 'project' });
  };
