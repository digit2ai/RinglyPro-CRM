...
module.exports = (sequelize, DataTypes) => {
  const TelemetryEvent = sequelize.define('LogisticsTelemetryEvent', {
    id: {
    ...
    tableName: 'logistics_telemetry_events',
    underscored: true,
    timestamps: true,
    indexes: [
      { fields: ['project_id'] },
  ...
  TelemetryEvent.associate = (models) => {
    TelemetryEvent.belongsTo(models.LogisticsProject, { foreignKey: 'project_id', as: 'project' });
  };
