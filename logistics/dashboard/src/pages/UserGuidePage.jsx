...
function StepCard({ number, title, children, isActive, onClick }) {
  return (
    <div className={`rounded-lg border transition-all ${isActive ? 'border-logistics-500/50 bg-slate-800/80' : 'border-slate-700 bg-slate-800/40'}`}>
      <button onClick={onClick} className="w-full flex items-center gap-4 p-5 text-left">
        <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-sm font-bold flex-shrink-0 ${
          isActive ? 'bg-logistics-600 text-white' : 'bg-slate-700 text-slate-400'
        }`}>
          {number}
        </div>
    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <button
          ...
          className={`p-6 rounded-lg border-2 text-left transition-all ${
            activeScenario === 0
              ? 'border-logistics-500 bg-logistics-600/10'
              : 'border-slate-700 bg-slate-800/50 hover:border-slate-600'
          }`}
        >
          <div className="flex items-center gap-3 mb-3">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              activeScenario === 0 ? 'bg-logistics-600 text-white' : 'bg-slate-700 text-slate-400'
            }`}>
            ...
            <span className={`text-xs font-medium px-2 py-0.5 rounded ${
              activeScenario === 0 ? 'bg-logistics-600/30 text-logistics-300' : 'bg-slate-700 text-slate-400'
            }`}>Overview</span>
          </div>
          <h3 className="text-lg font-semibold text-white mb-1">How a Warehouse Works</h3>
          <p className="text-sm text-slate-400">Learn the fundamentals of warehouse logistics and how LOGISTICS analyzes operations.</p>
        </button>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              activeScenario === 1 ? 'bg-logistics-600 text-white' : 'bg-slate-700 text-slate-400'
            }`}>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              activeScenario === 2 ? 'bg-logistics-600 text-white' : 'bg-slate-700 text-slate-400'
            }`}>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <span className={`text-xs font-medium px-2 py-0.5 rounded ${
              activeScenario === 2 ? 'bg-logistics-600/30 text-logistics-300' : 'bg-slate-700 text-slate-400'
            }`}>Scenario 2</span>
          </div>
      ...
      {activeScenario === 0 && (
        <div className="space-y-6">
          {/* Intro */}
          <div className="card bg-gradient-to-r from-logistics-900/30 to-slate-800 border-logistics-700/30">
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-logistics-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" />
              </svg>
              <div>
          ...
          >
            <div className="ml-14 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                  <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">LOGISTICS Mapping</p>
                  <p className="text-sm text-slate-300">This data maps to the <strong className="text-logistics-300">Goods In</strong> file. LOGISTICS uses it to analyze inbound throughput patterns and supplier delivery frequency.</p>
                </div>
              </div>
            </div>
          </StepCard>
          ...
          >
            <div className="ml-14 space-y-3">
              ...
              <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">LOGISTICS Mapping</p>
                <p className="text-sm text-slate-300">The <strong className="text-logistics-300">Item Master</strong> file provides SKU dimensions and weights to determine bin-capability. The <strong className="text-logistics-300">Inventory</strong> snapshot shows current stock levels and storage locations. LOGISTICS calculates what percentage of items fit in standard bins — a key metric for automation feasibility.</p>
              </div>
            </div>
          </StepCard>
          ...
          >
            <div className="ml-14 space-y-3">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      ...
                      <tr className="border-t border-slate-700/50">
                        ...
                        <td className="py-2.5 text-center"><span className="px-2 py-0.5 rounded bg-logistics-500/20 text-logistics-300 text-xs font-mono">600–1,200</span></td>
              ...
              <div className="p-3 rounded-lg bg-logistics-900/20 border border-logistics-500/30">
              ...
              <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">LOGISTICS Mapping</p>
                <p className="text-sm text-slate-300">The <strong className="text-logistics-300">Goods Out</strong> file is the most critical dataset. LOGISTICS analyzes order structure (single vs multi-line split), throughput patterns (monthly, weekday, hourly peaks), and <strong className="text-white">ABC classification</strong> to identify which items drive 80% of activity (A-items) vs slow movers (C-items). Peak CPH requirements are derived from the busiest hours in your data.</p>
              </div>
            </div>
          </StepCard>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      ...
                      <tr className="border-t border-slate-700/50">
                        ...
                        <td className="py-2.5"><span className="px-2 py-0.5 rounded bg-logistics-500/20 text-logistics-300 text-xs font-mono">10-100 m</span></td>
                      </tr>
                      <tr className="border-t border-slate-700/50">
          ...
          >
            <div className="ml-14 space-y-3">
              ...
              <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                ...
                <p className="text-sm text-slate-300">Peak shipping days (often Monday-Wednesday) create bottlenecks. LOGISTICS identifies weekday and seasonal patterns so automation systems can be sized for actual peak demand, not just averages.</p>
              </div>
            </div>
          </StepCard>
          ...
          >
            <div className="ml-14 space-y-3">
              ...
              <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
                <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">LOGISTICS Insight</p>
                <p className="text-sm text-slate-300">LOGISTICS computes ABC classification by both <strong className="text-white">order frequency</strong> (how often an item is ordered) and <strong className="text-white">shipping volume</strong> (total units shipped). This dual classification reveals which items benefit most from automation investment.</p>
              </div>
            </div>
          </StepCard>
          ...
          >
            <div className="ml-14 space-y-3">
              <p className="text-sm text-slate-300">
                Automation investment decisions require a clear financial justification. LOGISTICS projects ROI across multiple benefit categories:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-slate-900/50 border border-slate-700">
              ...
              <div className="p-3 rounded-lg bg-logistics-900/20 border border-logistics-500/30">
                <p className="text-sm text-slate-300">LOGISTICS calculates <strong className="text-white">total annual savings</strong>, <strong className="text-white">payback period</strong>, and <strong className="text-white">5-year ROI</strong> based on your actual operational data — giving you the numbers to build a boardroom-ready business case.</p>
              </div>
            </div>
          </StepCard>
          ...
          >
            <div className="ml-14 space-y-3">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      ...
                      <tr className="border-t border-slate-700/50">
                        ...
                        <td className="py-2.5"><span className="px-2 py-0.5 rounded bg-logistics-500/20 text-logistics-300 text-xs font-mono">Per design</span></td>
              ...
              <div className="p-3 rounded-lg bg-logistics-900/20 border border-logistics-500/30">
                <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">LOGISTICS Observability</p>
                <p className="text-sm text-slate-300">In production mode, LOGISTICS can ingest live equipment telemetry and operational events via the Production API, providing a <strong className="text-white">real-time observability dashboard</strong> with system health gauges, throughput heatmaps, and anomaly alerts. The voice agent can also speak about current operational status on demand.</p>
              </div>
            </div>
          </StepCard>
        </div>
      ...
      {activeScenario === 1 && (
        <div className="space-y-4">
          <div className="card bg-gradient-to-r from-logistics-900/30 to-slate-800 border-logistics-700/30 mb-6">
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-logistics-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          >
            <p className="text-sm text-slate-300 ml-14">
              ...
              <strong className="text-logistics-400"> "Generate Report"</strong>. Once generated, click
              <strong className="text-logistics-400"> "Download PDF"</strong> to get a comprehensive report
          ...
          >
            ...
            <div className="ml-14 p-4 rounded-lg bg-logistics-900/20 border border-logistics-500/30 mt-2">
              ...
              <ul className="text-sm text-slate-300 space-y-1">
                ...
                <li>- "Which products are recommended for my warehouse?"</li>
        ...
        <div className="space-y-4">
          ...
          >
            <p className="text-sm text-slate-300 ml-14 mb-3">
              You need up to 4 data files. Column names are flexible — LOGISTICS auto-maps common aliases
              ...
              <div className="rounded-lg border border-slate-700 overflow-hidden">
                ...
                <div className="p-4">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      <tr className="border-t border-slate-700/50">
                        <td className="py-2 font-mono text-xs text-logistics-300">sku</td>
                ...
                <div className="p-4">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      ...
                      <tr className="border-t border-slate-700/50">
                        <td className="py-2 font-mono text-xs text-logistics-300">order_id</td>
                        <td className="py-2 text-red-300">Yes</td>
                        <td className="py-2">Order number</td>
                      </tr>
                      <tr className="border-t border-slate-700/50">
                        <td className="py-2 font-mono text-xs text-logistics-300">ship_date</td>
                        <td className="py-2 text-red-300">Yes</td>
                ...
                <div className="p-4">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-slate-300">
                      ...
                      <tr className="border-t border-slate-700/50">
                        <td className="py-2 font-mono text-xs text-logistics-300">receipt_date</td>
                        <td className="py-2 text-red-300">Yes</td>
...
SKU-003;2024-01-14;500;REC-503;Supplier Alpha`}</CodeBlock>
          ...
          >
            ...
            <ul className="ml-14 text-sm text-slate-300 space-y-2 mt-2">
              <li className="flex items-start gap-2">
                <CheckCircleIcon className="w-4 h-4 text-logistics-400 mt-0.5 flex-shrink-0" />
            ...
            <p className="ml-14 text-sm text-slate-400 mt-3">
              Click <strong className="text-logistics-400">"Continue to Upload"</strong> to proceed.
            </p>
            <div className="ml-14">
              <button onClick={() => navigate('/')} className="btn-ghost text-sm">
                Go to Upload Page &rarr;
          ...
          >
            ...
            <div className="ml-14 p-4 rounded-lg bg-slate-900/50 border border-slate-700 mt-2">
              ...
              <ul className="text-sm text-slate-400 space-y-1">
                <li>- CSV files can use <code className="text-logistics-300">;</code> or <code className="text-logistics-300">,</code> as delimiter (auto-detected)</li>
          ...
          >
            <p className="text-sm text-slate-300 ml-14">
              ...
              <strong className="text-logistics-400"> "Run Full Analysis"</strong> button becomes active.
