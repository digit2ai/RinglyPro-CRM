...
export default function AnalysisPage() {
  ...
  const handleDownloadReport = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `LOGISTICS-Report-${projectId}.pdf`
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-8">
        ...
        <div className="card">
          <h3 className="card-header flex items-center gap-2">
            <svg className="w-5 h-5 text-logistics-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  ...
                  {Object.entries(sysArch.scoring_breakdown).map(([key, item]) => (
                    <div key={key} className="flex items-center gap-3 text-sm">
                      ...
                      <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-logistics-500 rounded-full transition-all"
