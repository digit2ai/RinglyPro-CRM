...
module.exports = (sequelize, DataTypes) => {
  const GoodsOutData = sequelize.define('PinaxisGoodsOutData', {
    id: {
    ...
    tableName: 'pinaxis_goods_out_data',
    underscored: true,
    timestamps: true,
    indexes: [
      { fields: ['project_id'] },
  ...
  GoodsOutData.associate = (models) => {
    GoodsOutData.belongsTo(models.PinaxisProject, { foreignKey: 'project_id', as: 'project' });
  };
