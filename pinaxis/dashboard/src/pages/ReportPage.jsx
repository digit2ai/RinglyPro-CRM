  ...
  const reportSections = [
    ...
    },
    {
      ...
      description: topProduct
        ...
        : 'GEBHARDT product matching results with fit scores and reasoning.'
    }
  ]
    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="card mb-8">
        <div className="flex items-start gap-6">
          {/* Report Icon */}
          <div className="w-24 h-32 bg-gradient-to-b from-pinaxis-600 to-pinaxis-900 rounded-lg flex flex-col items-center justify-center flex-shrink-0 shadow-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm mb-4">
              ...
              throughput patterns, ABC analysis, bin fit results, and GEBHARDT product recommendations.
            </p>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {reportSections.map((section, index) => (
            ...
            >
              <div className="w-8 h-8 bg-pinaxis-600/20 rounded-lg flex items-center justify-center text-pinaxis-400 flex-shrink-0 mt-0.5">
                {section.icon}
              </div>
