      ...
      <div className="max-w-6xl mx-auto animate-fade-in">
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            <div className="w-10 h-10 border-2 border-pinaxis-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
              {[
                ...
                <div key={t.type} className="p-3 rounded-lg bg-slate-800 border border-slate-700 text-center">
                  <p className="text-xs font-mono text-pinaxis-300 mb-1">{t.type}</p>
