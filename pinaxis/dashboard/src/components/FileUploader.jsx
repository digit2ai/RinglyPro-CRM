  ...
  return (
    <div
      ...
      className={`border-2 border-dashed rounded-xl p-5 cursor-pointer transition-all duration-200
        ${isDragActive ? 'border-pinaxis-500 bg-pinaxis-500/10' : config.borderClass}
        ${status === 'uploading' ? 'opacity-75 cursor-wait' : 'hover:border-pinaxis-500/60 hover:bg-slate-800/50'}
      `}
    >
      <input {...getInputProps()} />
