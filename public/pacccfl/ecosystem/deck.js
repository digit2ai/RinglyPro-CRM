...
(function () {
  ...
  var SLIDES = [
    ...
    { kind: 'app', st: { screen: 'jobup' },
      t: { en: 'TornaJobs.dev — your global profile',
           es: 'TornaJobs.dev — tu perfil global',
           tl: 'TornaJobs.dev — ang iyong global na profile' },
      ...
      n: { en: 'Membership reaches past the chamber itself. TornaJobs turns your résumé into a living professional profile: real openings scored against what you have actually done, a public C V site that recruiters and their AI can read, and outreach drafted for you to approve before anything is sent. For a community where careers and businesses grow together, that is the same network doing double duty.',
           es: 'La membresía llega más allá de la propia cámara. TornaJobs convierte tu currículum en un perfil profesional vivo: vacantes reales evaluadas contra lo que realmente has hecho, un sitio de C V público que los reclutadores y su inteligencia artificial pueden leer, y mensajes redactados para que los apruebes antes de enviar nada. Para una comunidad donde las carreras y los negocios crecen juntos, es la misma red haciendo doble trabajo.',
           tl: 'Umaabot ang membership nang higit pa sa kamara mismo. Ginagawa ng TornaJobs na buhay na propesyonal na profile ang iyong résumé: tunay na bakanteng sinusukat laban sa aktuwal mong nagawa, isang pampublikong C V site na kayang basahin ng recruiter at ng AI nila, at outreach na idinrapt para aprubahan mo bago may maipadala. Para sa komunidad kung saan sabay lumalago ang karera at negosyo, iisang network iyan na doble ang trabaho.' } },
