  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="glass-card w-full max-w-lg">
        <h1 className="text-2xl font-bold text-white mb-2">{isES ? 'Registro - Comunidad Abierta' : 'Register - Open Community'}</h1>
        <p className="text-white/50 text-sm mb-6">{isES ? 'Gratis. Sin aplicacion. Sin limite.' : 'Free. No application. No cap.'}</p>
