...
(function (root) {
  var I18N = {
    en: {
      ...
      attachLabel: 'Attach files (PDF, Word, text)',
      attachHint: 'PDF, Word, text, CSV or RTF — up to 5 files, 10 MB each.',
      attachRemove: 'Remove',
      attachTooMany: 'You can attach up to 5 files.',
      attachTooBig: 'is too large (max 10 MB).',
      attachBadType: 'is not a supported file type.',
      ...
      inboxTab: 'Intercom',
      intakeTab: 'Send a request',
      inboxTitle: 'Intercom',
      inboxSub: 'Chat with the Digit2Ai team here.',
      intercomPlaceholder: 'Message the Digit2Ai team…',
      intercomSend: 'Send',
      intercomMic: 'Record voice message',
      intercomAttach: 'Attach file or photo',
      intercomCaption: 'Add a caption…',
      intercomDrop: 'Drop file to send',
      intercomSendingVoice: 'Sending voice…',
    ...
    es: {
      ...
      attachLabel: 'Adjuntar archivos (PDF, Word, texto)',
      attachHint: 'PDF, Word, texto, CSV o RTF — hasta 5 archivos, 10 MB cada uno.',
      attachRemove: 'Quitar',
      attachTooMany: 'Puedes adjuntar hasta 5 archivos.',
      attachTooBig: 'es demasiado grande (máx. 10 MB).',
      attachBadType: 'no es un tipo de archivo permitido.',
      attachAdded: 'adjunto(s)',
      ...
      inboxTab: 'Intercom',
      intakeTab: 'Enviar solicitud',
      inboxTitle: 'Intercom',
      inboxSub: 'Chatea aquí con el equipo de Digit2Ai.',
      intercomPlaceholder: 'Escribe al equipo de Digit2Ai…',
      intercomSend: 'Enviar',
      intercomMic: 'Grabar mensaje de voz',
      intercomAttach: 'Adjuntar archivo o foto',
      intercomCaption: 'Añade un comentario…',
      intercomDrop: 'Suelta el archivo para enviar',
      intercomSendingVoice: 'Enviando voz…',
