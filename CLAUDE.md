...
## BuyersLine — new-construction buyer platform (folder: incentiva, DIGIT2AI x Ole)
...
**RentCast coverage, measured 2026-09-13 in production (5 ZIPs, 182 unique homes):** 91% sourced from Stellar MLS, coordinates on all, **no builder name or community on any listing**, the large production builders (Lennar, D.R. Horton, Pulte, Taylor Morrison) essentially absent, median prices over $1M in 3 of 5 areas, median 300 to 520 days on market, only 41 of 182 between $250K and $700K. It is a traffic and lead hook, not the inventory source; the complete feed is Stellar MLS IDX through Ole's broker.
