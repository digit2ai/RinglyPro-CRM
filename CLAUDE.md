...
- **Demo company**: `LAWNCOPILOT_DEMO_OWNER_PASSWORD` (falls back to `LAWNCOPILOT_PLATFORM_PASSWORD`, default `lawncopilot@2026`) — owner password the seed force-sets for mstagg@digit2ai.com on "Lawn Co-Pilot". `LAWNCOPILOT_DEMO_COMPANY_SLUG` (`lawn-co-pilot`).
