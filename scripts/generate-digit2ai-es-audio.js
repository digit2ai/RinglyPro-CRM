...
// per character; Lina keeps the role, the API key requirement is gone.
const VOICE = process.env.NARRATION_VOICE || 'es-MX-DaliaNeural';
...
(async () => {
  ...
  console.log(`Voice: Lina Spanish (${VOICE}, ${RATE}) — Edge neural, no API key`);
  console.log('');
