...
(function () {
  ...
  var HALLAZGO = {
    ahorro: ['Tu fondo de emergencia aún es corto. Se considera saludable cubrir entre tres y seis meses de gastos; sepáralo poco a poco antes de invertir, es tu escudo.', 'Ya tienes algo de colchón, aunque todavía no cubre un imprevisto completo. Sigue separando y verás subir tu puntaje.', 'Tienes un buen respaldo para imprevistos. Mantén el hábito.'],
    ...
    impuestos: ['Tu tema tributario está por organizar. Revisa si te toca declarar y ordena tus soportes; en Impuestos, Maya te ayuda a entenderlo.', 'Vas encaminado en impuestos; organiza mejor tus soportes.', 'Estás al día y con tus soportes en orden.'],
