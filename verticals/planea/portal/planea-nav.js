...
(function () {
  ...
  function build() {
    ...
    maya.innerHTML = '<span class="orbe"><img src="' + BASE + 'images/maya.png" alt="Maya" aria-hidden="true"></span><span class="txt-short">Habla con Maya</span><span class="txt"><span class="t1">Pregúntale a Maya</span><span class="t2">Tu guía financiera IA</span></span>';
    ...
    if (ourCookie()) {
      fetch('/planea/api/v1/me/profile', { credentials: 'include' })
        ...
        .then(function (data) {
          ...
          hideMiPuntaje = false; // un solo Planea Score: tab siempre visible (progreso)
