...
(function () {
  ...
  function build() {
    ...
    top.innerHTML =
      ...
      '<button class="pl-daynight" id="pl-theme" aria-label="Cambiar tema"></button>' +
    ...
    function themeLabel() {
      ...
      document.getElementById('pl-theme').innerHTML = (light ? moon : sun) + '<span>' + (light ? 'Noche' : 'Día') + '</span>';
