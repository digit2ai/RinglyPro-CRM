/* PLANEA PWA service worker — app-shell caching.
   ...
   Scope: /planea/portal/. */
var CACHE = 'planea-shell-v28';
var BASE = '/planea/portal/';
var SHELL = [
  BASE + 'inicio', BASE + 'patrimonio', BASE + 'metas', BASE + 'ingreso', BASE + 'gastos', BASE + 'cuentas', BASE + 'diagnostico',
  ...
  BASE + 'planea-diagnostico.js', BASE + 'planea-patrimonio-edit.js', BASE + 'planea-metas-edit.js', BASE + 'planea-module-edit.js', BASE + 'maya-chat.js',
