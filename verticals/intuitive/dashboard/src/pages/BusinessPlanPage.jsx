...
export default function BusinessPlanPage({ projectId: propId }) {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      {/* Page Title + Workflow Step Header */}
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="text-[10px] uppercase tracking-widest text-blue-400 font-bold mb-1">Step 8 of 9 · Hospital Workflow</div>
        ...
        <div className="flex gap-2 items-center">
          <button onClick={() => navigate(`/commitments/${id}`)} className="text-sm text-slate-400 hover:text-slate-200">← Surgeon Commitments</button>
          <button onClick={() => navigate(`/executive/${id}`)} className="bg-slate-700 hover:bg-slate-600 text-white text-sm px-4 py-2 rounded">
            Executive Brief
          </button>
          <button onClick={() => navigate(`/tracking/${id}`)} className="bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold px-4 py-2 rounded">
