...
function renderCharts(){
  ...
  if(title.includes('Hospital Profile')){
    if(chartData.wfStrategicImpact&&chartData.wfStrategicImpact.length){
      mk('wfStrategicImpact',{type:'bar',data:{labels:chartData.wfStrategicImpact.map(d=>d.label),datasets:[{label:'Impact',data:chartData.wfStrategicImpact.map(d=>d.value),backgroundColor:xi,borderRadius:3}]},options:{...hOpts,layout:{padding:{right:150}},plugins:{...hOpts.plugins,datalabels:{display:true,color:'#e2e8f0',font:{size:10,weight:'bold'},anchor:'end',align:'end',offset:6,clamp:true,clip:false,formatter:(v,ctx)=>chartData.wfStrategicImpact[ctx.dataIndex].display||v}}}})
    }
...
window.addEventListener('load',function(){
  ...
  if(chartData.wfStrategicImpact&&chartData.wfStrategicImpact.length){mk('wfStrategicImpact',{type:'bar',data:{labels:chartData.wfStrategicImpact.map(function(d){return d.label;}),datasets:[{label:'Impact',data:chartData.wfStrategicImpact.map(function(d){return d.value;}),backgroundColor:xi,borderRadius:3}]},options:Object.assign({},hOpts,{layout:{padding:{right:150}},plugins:Object.assign({},hOpts.plugins,{datalabels:{display:true,color:'#e2e8f0',font:{size:10,weight:'bold'},anchor:'end',align:'end',offset:6,clamp:true,clip:false,formatter:function(v,ctx){return chartData.wfStrategicImpact[ctx.dataIndex].display||v;}}})})});}
