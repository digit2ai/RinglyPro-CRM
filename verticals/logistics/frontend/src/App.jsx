...
function Sidebar({ open, onClose, tierInfo }) {
  ...
  const allNav = [
    ...
    { path: `${BASE}/nda`, label: 'NDA Signing', roles: ['admin'], section: 'LEGAL' },
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path={`${BASE}/nda`} element={<ProtectedRoute roles={['admin']}><Layout tierInfo={ti}><NDA /></Layout></ProtectedRoute>} />
