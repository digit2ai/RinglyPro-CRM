...
const T = {
  en: {
    ...
    uvegText: 'Public state university of Mexico (Gov. of Guanajuato). UVEG provides the Spanish as a Foreign Language (SFL) program: 12 modules × 6 lessons each (72 total lessons), 30 teaching hours per module on a 100% interactive platform. CEFR-aligned from A1, open 365 days/year, asynchronous + 2h/week virtual instructor sessions. Certificate per accredited module. Memorandum of Understanding (MOU) signed with Multi Travel Connection, Inc (DBA Torna Idioma).',
    uvegStrengths: 'Program Structure',
    uvegS1: '12 modules × 6 lessons = 72 lessons total',
    uvegS2: '30 teaching hours per module on digital platform',
    uvegS3: '2 hours of practice with virtual instructor per week',
    uvegS4: 'Certificate for each accredited module',
    uvegS5: 'Asynchronous, 100% interactive, open 365 days',
    uvegS6: '$530 MXN per module (~$0.78 USD/hour/student)',
  ...
  es: {
    ...
    uvegTitle: 'Universidad Virtual del Estado de Guanajuato (UVEG)',
    uvegText: 'Universidad pública estatal de México (Gob. de Guanajuato). UVEG proporciona el programa de Español como Lengua Extranjera (ELE): 12 módulos × 6 lecciones cada uno (72 lecciones totales), 30 horas de enseñanza por módulo en plataforma 100% interactiva. Alineado al MCER desde A1, abierto 365 días/año, asincrónico + 2h/semana con instructor virtual. Certificado por módulo acreditado. MOU firmado con Multi Travel Connection, Inc (DBA Torna Idioma).',
    uvegStrengths: 'Estructura del Programa',
    uvegS1: '12 módulos × 6 lecciones = 72 lecciones en total',
    uvegS2: '30 horas de enseñanza por módulo en plataforma digital',
    uvegS3: '2 horas de práctica con instructor virtual por semana',
    uvegS4: 'Certificado por cada módulo acreditado',
    uvegS5: 'Asincrónico, 100% interactivo, abierto 365 días',
    uvegS6: '$530 MXN por módulo (~$0.78 USD/hora/estudiante)',
  ...
  fil: {
    ...
    met4: 'Satisfaction ≥ 4.5/5',
    uvegTitle: 'Universidad Virtual del Estado de Guanajuato (UVEG)',
    uvegText: 'Pampublikong unibersidad ng estado ng Mexico (Gov. ng Guanajuato). 12 modules × 6 lessons bawat isa (72 lessons kabuuan), 30 oras ng pagtuturo bawat module sa 100% interactive platform. CEFR-aligned mula A1, bukas 365 araw/taon, asynchronous + 2h/linggo kasama ang virtual instructor. Sertipiko bawat accredited module. MOU signed kasama ang Torna Idioma.',
    uvegStrengths: 'Program Structure',
    uvegS1: '12 modules × 6 lessons = 72 lessons kabuuan',
    uvegS2: '30 oras ng pagtuturo bawat module sa digital platform',
    uvegS3: '2 oras ng practice kasama ang virtual instructor bawat linggo',
    uvegS4: 'Sertipiko para sa bawat accredited module',
    uvegS5: 'Asynchronous, 100% interactive, bukas 365 araw',
    uvegS6: '$530 MXN bawat module (~$0.78 USD/oras/estudyante)',
    uvegSkills: '4 Core Skills: Speaking, Listening, Reading, Writing',
    letranTitle: 'Colegio de San Juan de Letrán',
...
const partners = [
  { name: 'Universidad Virtual del Estado de Guanajuato (UVEG)', country: 'Mexico', flag: '🇲🇽', type: 'Academic Supplier — MOU Signed', role: '12 modules × 6 lessons (72 total), 30h/module, 100% digital platform, CEFR A1+, certified teachers, $530 MXN/module', year: 'Public University' },
