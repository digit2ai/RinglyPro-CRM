...
(async () => {
  ...
  try {
    ...
    ok(r.txt.slice(r.txt.indexOf('<section class="hero-band">'), r.txt.indexOf('<section id="flow"')).includes('</section>'), 'the hero band CLOSES before the next section (it once wrapped the whole page)');
