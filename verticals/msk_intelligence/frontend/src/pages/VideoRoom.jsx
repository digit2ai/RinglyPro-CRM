        ...
        <div className="w-full max-w-lg">
          <div className="card bg-dark-900 p-8">
            <div className="text-center mb-8">
              <img src="https://storage.googleapis.com/msgsndr/3lSeAHXNU9t09Hhp9oai/media/68ec2cfb385c9833a43e685f.png" alt="MSK Intelligence" className="w-16 h-16 rounded-2xl shadow-2xl object-cover mx-auto mb-4" />
