        ...
        <div className="w-full max-w-lg">
          <div className="card bg-dark-900 p-8">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-msk-500 to-msk-700 flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4 shadow-2xl">
                M
              </div>
    ...
    <div className="h-screen bg-black flex flex-col">
      ...
      <div className="bg-dark-900/90 backdrop-blur-sm border-b border-dark-800 px-4 py-2 flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-msk-500 to-msk-700 flex items-center justify-center text-white font-bold text-sm">
            M
          </div>
          <div>
