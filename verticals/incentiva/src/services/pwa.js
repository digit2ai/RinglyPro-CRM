...
const SHELL_VERSION = 'bl-shell-29';
...
const SHELL = [BASE + '/', BASE + '/search', BASE + '/offline', BASE + '/admin/', BASE + '/admin/login',
  BASE + '/site.css', BASE + '/theme.js', BASE + '/flow.js', BASE + '/intake-chat.js', BASE + '/report-view.js', BASE + '/nav.js', BASE + '/install.js', BASE + '/search-widget.js', BASE + '/admin.js',
