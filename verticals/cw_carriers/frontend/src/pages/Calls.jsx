...
const s = {
  ...
  stat: { background: '#161B22', border: '1px solid #21262D', borderRadius: 8, padding: '10px 14px', textAlign: 'center', minWidth: 70, flex: '1 1 70px' },
  statVal: { fontSize: 22, fontWeight: 700, fontFamily: "'Bebas Neue', sans-serif" },
