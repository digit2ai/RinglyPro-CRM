...
const s = {
  ...
  section: { background: '#161B22', border: '1px solid #21262D', borderRadius: 10, padding: '20px 16px' },
  ...
  btnRow: { display: 'flex', gap: 12, marginTop: 14, flexWrap: 'wrap' },
  ...
  previewBox: { marginTop: 16, border: '1px solid #30363D', borderRadius: 8, overflow: 'auto', WebkitOverflowScrolling: 'touch' },
