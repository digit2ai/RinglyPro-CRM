...
const s = {
  ...
  funnelRow: { display: 'flex', alignItems: 'center', gap: 16, justifyContent: 'center', flexWrap: 'wrap' },
  funnelStep: { textAlign: 'center', padding: 12, background: '#0D1117', borderRadius: 8, minWidth: 100 },
  ...
  callBreakdown: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 },
