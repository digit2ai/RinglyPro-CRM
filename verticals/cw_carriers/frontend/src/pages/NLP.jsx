...
const s = {
  ...
  inputArea: { display: 'flex', gap: 8, marginBottom: 16 },
  input: { flex: 1, padding: '14px 18px', background: '#161B22', border: '2px solid #1A4FA8', borderRadius: 10, color: '#E6EDF3', fontSize: 15, outline: 'none' },
  sendBtn: { padding: '14px 24px', background: '#1A4FA8', color: '#fff', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  voiceBtn: { padding: '14px 18px', background: '#21262D', color: '#8B949E', border: 'none', borderRadius: 10, fontSize: 14, cursor: 'pointer' },
